...
if __name__ == '__main__':
    ...
    hyper_network = HyperNetwork(z_dim=v_dim + f_dim, label_size=num_class, net_type=type, zoom_dim=zoom_size)
    ...
    args.near_ood = True
    folder_name = f"{args.dataset}-{'nearood' if args.near_ood else 'farood'}"
    ...
    params = params + list(hyper_network.parameters())
            ...
            for split in ['train', 'val', 'test']:
                ...
                with tqdm.tqdm(total=len(dataloaders[split])) as pbar:
                    ...
                    if split == 'test':
                        ...
                        if currentvalAcc >= BestAcc and epoch_i >= 10:
                        ...
                        if args.save_checkpoint and ((epoch_i >= 10 and epoch_i % 2 == 0) or epoch_i == 0):
